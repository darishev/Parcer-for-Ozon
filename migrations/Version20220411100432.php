 ...
 */
final class Version20220411100432 extends AbstractMigration
{
    /**
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADDF4C85EA FOREIGN KEY (seller_id_id) REFERENCES seller (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
