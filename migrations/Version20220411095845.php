 ...
 */
final class Version20220411095845 extends AbstractMigration
{
    /**
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, seller_id_id INT NOT NULL, sku INT NOT NULL, price INT NOT NULL, name VARCHAR(255) NOT NULL, reviews_count INT NOT NULL, created_date INT NOT NULL, updated_date INT NOT NULL, INDEX IDX_D34A04ADDF4C85EA (seller_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
