 ...
 */
final class Version20220414150043 extends AbstractMigration
{
    /**
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, seller_id INT NOT NULL, sku INT NOT NULL, price INT NOT NULL, name VARCHAR(255) NOT NULL, reviews_count INT DEFAULT NULL, created_date INT NOT NULL, updated_date INT NOT NULL, INDEX IDX_B3BA5A5A8DE820D9 (seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
